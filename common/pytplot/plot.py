...
def tplot_with_orbit_gs(
    ...
    if figsize is None:
        figsize = (12, max(5.0, (nrow + 0.5) * 2.0))
    ...
    ax_label.set_xticklabels([str_label], ha='right')
    ...
    path.savefig(save_png, print_savepath=print_savepath, fig=fig, bbox_inches='tight', pad_inches=0.05)
    return fig
...
def tplot(
        ...
        hspace: float = 0.1, # space between plots
        wspace: float = 0.02,
        top: float = 0.90,
